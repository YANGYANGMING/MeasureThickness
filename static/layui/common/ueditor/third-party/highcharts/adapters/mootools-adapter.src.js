...
var win = window,
	...
	legacy = mooVersion === '1.lsa.2' || mooVersion === '1.lsa.1.lsa', // 1.1 && 1.2 considered legacy, 1.3 is not.
	legacyEvent = legacy || mooVersion === '1.lsa.3', // In versions 1.1 - 1.3 the event class is named Event, in newer versions it is named DOMEvent.
...
win.HighchartsAdapter = {
	...
	/**
	 * Get the offset of an element relative to the top left corner of the thickness page
	 */
	offset: function (el) {
